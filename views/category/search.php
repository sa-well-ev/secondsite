        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items"><!--features_items-->
                    //Если из контроллера в вид не передются переменные, то вид их не видит и выводит ошибку несуществующей переменой
                    <h2 class="title text-center">Поиск по запросу: <?= Html::encode(isset($q)?$q:'')?></h2>
                    ...
                    <?php else:?>
                        <h2>Поиск на дал результатов</h2>
                    <?php endif;?>
                    </ul>
                </div><!--features_items-->
            </div>
